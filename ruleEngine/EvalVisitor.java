...
public class EvalVisitor extends RuleBaseVisitor<Boolean> {
	 ...
	 */
	@Override public Boolean visitQuestionReplyOption( RuleParser.QuestionReplyOptionContext ctx) { 
	 ...
	 * {@link #visitChildren} on {@code ctx}.</p>
	 */
	@Override public Boolean visitScoringcategoryValue( RuleParser.ScoringcategoryValueContext ctx) { 
		return Utility.compareScoringCategoryValue(ctx.SCORINGCATEGORY().getText(),ctx.VALUE().getText(),Utility.Comparison.EQUALS);
	 ...
	 * {@link #visitChildren} on {@code ctx}.</p>
	 */
	@Override public Boolean visitScoringcategoryMoreThanValue( RuleParser.ScoringcategoryMoreThanValueContext ctx) { 

		return Utility.compareScoringCategoryValue(ctx.SCORINGCATEGORY().getText(),ctx.VALUE().getText(),Utility.Comparison.MORE_THAN);
	 ...
	 * {@link #visitChildren} on {@code ctx}.</p>
	 */
	@Override public Boolean visitScoringcategoryLessThanValue( RuleParser.ScoringcategoryLessThanValueContext ctx) { 
       
		return Utility.compareScoringCategoryValue(ctx.SCORINGCATEGORY().getText(),ctx.VALUE().getText(),Utility.Comparison.LESS_THAN);
