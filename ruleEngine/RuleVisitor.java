...
public interface RuleVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link RuleParser#scoringcategoryValue}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitScoringcategoryValue(@NotNull RuleParser.ScoringcategoryValueContext ctx);
	...
	/**
	 * Visit a parse tree produced by {@link RuleParser#scoringcategoryMoreThanValue}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitScoringcategoryMoreThanValue(@NotNull RuleParser.ScoringcategoryMoreThanValueContext ctx);
	...
	/**
	 * Visit a parse tree produced by {@link RuleParser#scoringcategoryLessThanValue}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitScoringcategoryLessThanValue(@NotNull RuleParser.ScoringcategoryLessThanValueContext ctx);
